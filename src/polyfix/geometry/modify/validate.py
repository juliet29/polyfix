...
from polyfix.config import OVERLAP_TOLERANCE
...
from polyfix.geometry.vectors import is_perp_to_basis_vectors
from polyfix.visuals.visuals import plot_layout_alone, plot_polygon
